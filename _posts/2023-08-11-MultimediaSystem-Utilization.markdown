...
- Multimedia video and audio processing technology ⇒ Used as an effective multimedia education method.   
...
- Advantages   
  - Distance learning transcends time and space, allowing you to make the most of your time.   
- Disadvantage   
...
- Preparing for game design   
  ...
  - ③ Storyboard creation and character design   
...
- Game design course   
  ...
  |Debug operation|Finalizing game production.|
...
- To produce a game, many experts form a team and work together.   
  ...
  - Scenario Writer: The scenario writer completes the game's story.   
...
- Approximately 7 steps from product search at an internet shopping mall to delivery.   
  - ① Consumers select products at an online shopping mall.   
  - ② The shopping mall operator requests the consumer’s credit verification from the authentication center.   
  - ③ Consumer authentication from the authentication center.   
  - ④ The shopping mall operator requests payment from the consumer.   
  - ⑤ Payment system through credit card, electronic money, etc.   
  - ⑥ Consumer payment   
  - ⑦ Product is delivered to consumer.   
