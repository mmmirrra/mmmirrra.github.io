...
- The ambiguous part is clearly described by employing the grammar of the programming language   
- Describing parts that do not need to be expressed in detail in an explanatory manner through natural language   
- Used only to explain how the algorithm works   
- Using Pseudo Code based on C Language   
