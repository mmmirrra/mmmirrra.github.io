...
- A model that formalized the relationship between object and object made up of real-world attributes   
...
// - 예시   
- entity   
  - A tangible and intangible object that distinguishes it from other object in the real-world   
  - consists of several attributes that describe an object   
  - Example   
    - Student number 20230101-010101, Name Hong, Gender Woman, Age 20
- entity set   
  - A group of object that share the same attribute   
  - Example   
...
- Relational sets   
  - Association relationships between sets of object   
  - Example   
...
- The ER model provides a representation method to define the constraints that data must adhere to for the accuracy of representations about object and relationships   
...
// - 다대일 (N : 1)   
// - 다대다 (N : N)   
- Specify how many object one can relate to another for a set of object that participate in a relational set   
  - One-to-One (1 : 1)   
  - One-to-Many (1 : N)   
  - Many-to-One (N : 1)   
  - Many-to-Many (N : N)   
...
- An overall participation   
  - The condition that all object in any alternate set participate in a relationship set   
  - Mark as a double line =   
- Partial participation   
  - Conditions under which some object in a set of object participate in a set of relationships   
...
- A set of attributes with a unique value used to distinguish each object   
  - Role of uniquely distinguishing object   
...
- Properties of Relationship Sets : Properties that store values that are generated by relationships between two sets of object   
- Recursive relationship : A relationship in which a set of object forms a set of relationships with itself. The function performed by an object participating in a relationship is called the role of the object   
- Example   
...
- A weak set of object   
  - A set of object whose existence depends on the existence of the object it is associated with   
  - A weak set of object must be associated to a strong set of object through a 1 : N relationship set, and a discriminator (or subkey) of a weak set of object is a set of attributes that distinguish object within a weak set of object   
...
- A strong set of object   
  - General set of object associated with a weak set of object
- Example   
  - An account is a weak set of object because when a student object disappears, the account object also disappears   
  - The student object disappears when the account object disappears, so the student is a strong set of object   
