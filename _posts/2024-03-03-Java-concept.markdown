...
```c
#include <stdio.h>
int e[2];           // Variables for English Grades
int m[2];           // Variables for Math Grades

void input_grade()         // a function that receives English and Math grades
{
  e[0] = 90;        // the first student's English grades
  e[1] = 80;        // the second student's English grade
  m[0] = 85;        // the first student's Math grades
...
```java
class Grade {
  int e;          // Variables for English Grades
  int m;          // Variables for Math Grades
